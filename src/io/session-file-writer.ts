 ...
 */
export async function writeSessionFile(filePath: string, content: string): Promise<void> {
  try {
 ...
 */
export async function createTodosFile(sessionId: string, claudeDir: string): Promise<void> {
